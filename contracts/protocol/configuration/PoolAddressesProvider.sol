...
contract PoolAddressesProvider is Ownable, IPoolAddressesProvider {
  ...
  bytes32 private constant PYTH = 'PYTH';
  ...
  /// @inheritdoc IPoolAddressesProvider
  function getPyth() external view override returns (address) {
    return getAddress(PYTH);
  }

  /// @inheritdoc IPoolAddressesProvider
  function setPyth(address newPyth) external override onlyOwner {
    address oldPyth = _addresses[PYTH];
    _addresses[PYTH] = newPyth;
